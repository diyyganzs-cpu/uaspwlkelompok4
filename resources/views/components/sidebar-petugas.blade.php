<div class="col-md-2 sidebar-container min-vh-100 shadow p-0">
    <div class="p-4 text-center border-bottom border-light border-opacity-10">
        <h5 class="fw-bold text-white mb-0">
            <i class="fas fa-bullhorn me-2"></i> SIPM <small class="fw-light opacity-50">Petugas</small>
        </h5>
    </div>
    ...
    <ul class="nav flex-column mt-3 px-3">
        @php
            $menu = [
                ['name' => 'Dashboard', 'route' => 'petugas.dashboard', 'icon' => 'fa-th-large'],
                ['name' => 'Kelola Pengaduan', 'route' => 'petugas.index', 'icon' => 'fa-clipboard-list'],
                ['name' => 'Riwayat', 'route' => 'petugas.riwayat', 'icon' => 'fa-list-ul'],
            ];
        @endphp
